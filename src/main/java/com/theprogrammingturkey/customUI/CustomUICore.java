...
@Mod(modid = CustomUICore.MODID, version = CustomUICore.VERSION, name = CustomUICore.NAME, dependencies = "required-after:gobblecore[0.1.4.13,)", guiFactory = CustomUICore.GUIFACTORY)
